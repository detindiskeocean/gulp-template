...
if (!fs.existsSync("./package.json")) {
	console.log("Please run <npm intit> before you run this file");
	process.exit(1);
}
...
exec("npm i -D @babel/core @babel/preset-env gulp gulp-babel gulp-connect gulp-imagemin gulp-pug gulp-rename gulp-sass gulp-sourcemaps gulp-uglify imagemin-jpeg-recompress", function(err, stdout, stderr) {
	if (err) {
		console.log(err);
		process.exit(1);
	}
